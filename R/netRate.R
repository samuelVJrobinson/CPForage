...
#'  h=1.5,f=0.86,l=1,p_i=1,c_i=0.0042,c_f=0.05,H=100,alphaVal=5e-05,beta=0.102,S=0.5)
netRate=function(L,L_max,e,d,v,h,f,l,p_i,c_i,c_f,H,S,alphaVal,beta){
  ...
  Gains=L*e
  FlightLoss= (c_f*d*(L*alpha(c_f,L_max,e,alphaVal)+L_max))/(L_max*v)
