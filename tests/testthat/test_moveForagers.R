# context('Forager moving function (moveForagers)')

#Create scenario
nests<-list(nest1=list(xloc=1,yloc=1,n=matrix(c(5,10,15),1),
                       whatCurr="eff",sol=FALSE,
...
test_that('Currency calculations work properly',{
  newScenSet=moveForagers(scenSet,1,moves)
  expect_equal(newScenSet$base$world$S,matrix(c(0.6809744,0.668982,0.4761266),1),tol=1e-4)
